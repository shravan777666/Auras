...
const PLTrendChart = ({ data, loading, error }) => {
  if (loading) {
    return (
    ...
    plugins: {
      legend: {
        ...
        labels: {
          ...
          // Custom legend labels with color coding
        ...
        onClick: function(e, legendItem, legend) {
          ...
          if (index === 2) { // For Net Profit/Loss, toggle the dataset
            ci.setDatasetVisibility(index, !ci.isDatasetVisible(index));
            ci.update();
          } else { // For Revenue and Costs, keep them visible but allow toggling
            ci.setDatasetVisibility(index, !ci.isDatasetVisible(index));
            ci.update();
          }
        }
