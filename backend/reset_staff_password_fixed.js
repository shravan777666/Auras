...
// Function to reset staff password correctly (working with pre-save hook)
const resetStaffPasswordFixed = async () => {
  try {
    // Connect to database
    await connectDB();
    ...
    console.log('\n✅ Password reset completed. You can now test login with password: 123456');
  } catch (error) {
